...
int[] colorCodes = {
  #000000, #000000, #000000, #032952, #032952, #032952, #61032b, #61032b, #003b42, #91cbdf,
  #c7e0c8, #404040, #f0ded9,#f0f0f0, #edebe9, #381a5c, #9ebdd6, #899c7a, #A98A69, #f7a55f,
  ...
  #016a4b, #943030, #00489F, #394261, #cecebf, #cc8544, #c96745, #93aeca, #b5b791, #d2a366
};

String[] colorNames = {
  "knight-black", "knight-black-melange", "knight-black-reflective-print", "abyss-blue", "abyss-blue-melange",
  "abyss-blue-reflective-print", "velvet-red", "velvet-red-melange", "sunken-teal", "electric-blue",
  "frozen-green", "gravel-grey", "orchid-haze", "arctic-white", "clouded-dune", "purple-shadow", "blurred-nebular",
  "stone-green", "rigid-copper", "burnt-copper", "sportsgrey-light", "sportsgrey-light-reflective-print",
  ...
  "pistachio-cream", "ocher-clay", "timber-brown", "blue-void", "green-glare", "cocoa-gold"
};
